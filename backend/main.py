...
from app.router.campus import campus_router
from app.router.health import health_router
from app.router.schedule import schedule_router
from app.router.source_file import source_file_router
...
from app.modules.service_process.router import service_process_router
...
app.include_router(service_process_router)
