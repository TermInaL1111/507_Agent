...
export const apiConfig = {
  ...
  endpoints: {
    ...
    getTrainingProgramFiles: '/api/training-program/files',
    importTrainingProgram: '/api/training-program/import',
    importTrainingProgramBatch: '/api/training-program/import-batch',
    getTrainingProgramImportStatus: '/api/training-program/import-status',
    ...
    searchCampusLocations: '/api/campus/locations/search',
